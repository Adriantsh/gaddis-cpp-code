...
//*******************************************************************
// The linear search function performs a linear search on an        *
...
int linearSearch(const int arr[], int size, int value)
{
    ...
    int position = -1;  // To record position of searched value
