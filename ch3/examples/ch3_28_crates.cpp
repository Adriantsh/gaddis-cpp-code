...
// of any size. It calculates this data from user inout, which
// consists of the dimenions of the crate.
#include <iostream>
#include <iomanip>
using namespace std;
...
int main()
{
    // Constants for cost and amount chraged
    ...
    // Calculate te crate's volume, the cost to produce it,
